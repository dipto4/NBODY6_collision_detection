...
*
*     starsmasher interface
      COMMON/ENCOUNTERQU/ X1Q(0:5,1:NMAX), X2Q(0:5,1:NMAX),
     &                    X3Q(0:5,1:NMAX), V1Q(0:5,1:NMAX),
     &                    V2Q(0:5,1:NMAX), V3Q(0:5,1:NMAX),
     &                    IQNAME(0:5,1:NMAX),QTIME(0:5),
     &                   IENCOUNTERQ(0:5), 
     &                   IQFRONT, IQREAR, IQSTEPS,
     &                  ICOLLHAPPENED, IQSIZE
